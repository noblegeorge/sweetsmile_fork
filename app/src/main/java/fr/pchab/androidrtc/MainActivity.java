...
//        client.on("receiveCall", onReceiveCall);
        startService(this.findViewById(android.R.id.content));
...
/*    public Emitter.Listener onReceiveCall = new Emitter.Listener() {
        @Override
...
/*    class AddFriendTask extends AsyncTask<String, Void, Integer> {
 ...
 /*   class ListFriendsTask extends AsyncTask<String, Void, String> {
    ...
    class RetrieveName extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            try {
                ...
                //Post Data
                List<NameValuePair> nameValuePair = new ArrayList<NameValuePair>(1);
                nameValuePair.add(new BasicNameValuePair("phone", user));
                ...
                try {
                    ...
                    json_string = EntityUtils.toString(response.getEntity());
                    JSONObject x = new JSONObject(json_string);
                    json_string = x.getString("username");
     ...
     */
    public void dispatchCall(String callNum) {
//        client.close();
